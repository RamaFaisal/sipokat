    ...
    public function run(): void
    {
        $criteria = [
            [
                ...
                'weight' => 0.300,
                'sort_order' => 1,
                'description' => 'Jumlah stok obat saat ini (strip/botol). Semakin sedikit semakin prioritas.',
                'scale_rules' => [
            ...
            [
                ...
                'weight' => 0.200,
                'sort_order' => 3,
                'description' => 'Sisa hari sampai obat kedaluwarsa (FEFO batch terdekat). Semakin dekat semakin prioritas.',
                'scale_rules' => [
                    ['min' => null, 'max' => 90,   'score' => 5],
                    ['min' => 91,   'max' => 180,  'score' => 4],
                    ['min' => 181,  'max' => 365,  'score' => 3],
                    ['min' => 366,  'max' => 730,  'score' => 2],
                    ['min' => 731,  'max' => null, 'score' => 1],
                ],
            ],
            [
                'code' => 'C4',
                ...
                'weight' => 0.200,
                'sort_order' => 4,
                'description' => 'Harga beli obat per unit (Rp). Semakin murah semakin prioritas.',
                'scale_rules' => [
                    ['min' => null,   'max' => 10000,  'score' => 5],
                    ['min' => 10001,  'max' => 25000,  'score' => 4],
                    ['min' => 25001,  'max' => 50000,  'score' => 3],
                    ['min' => 50001,  'max' => 100000, 'score' => 2],
                    ['min' => 100001, 'max' => null,   'score' => 1],
                ],
            ],
        ];
