...
- **Master Data**: obat (satuan jual, kemasan beli + isi, batas minimum; kode `OBT####` otomatis), PBF, satuan. Kategori dikunci 3 golongan (Obat Bebas, Obat Keras, Alat Kesehatan) sesuai data apotek.
